...
{
    [DbContext(typeof(RoomReservtionDbContext))]
    [Migration("20220116232318_AddAuditToReservation")]
    partial class AddAuditToReservation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoomReservtion.Facilities.Facility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoomReservtion.Reservations.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoomReservtion.Rooms.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FacilityRoom", b =>
                {
                    b.HasOne("RoomReservtion.Facilities.Facility", null)
                        .WithMany()
                        .HasForeignKey("FacilitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoomReservtion.Rooms.Room", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoomReservtion.Reservations.Reservation", b =>
                {
                    b.HasOne("RoomReservtion.Rooms.Room", "Room")
                        .WithMany()
